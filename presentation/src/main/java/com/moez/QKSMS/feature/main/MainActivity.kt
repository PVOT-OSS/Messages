...
import dev.danascape.messages.databinding.MainActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        theme
                ...
                .subscribe { theme ->
                    ...
                    // Set the FAB compose icon color to stand out on the frosted background
        ...
        when {
            !state.defaultSms -> {
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarTitle)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_default_sms_title)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarMessage)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_default_sms_message)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarButton)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_default_sms_change)
                }
            }

            !state.smsPermission -> {
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarTitle)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_required)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarMessage)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_sms)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarButton)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_allow)
                }
            }
            ...
            !state.contactPermission -> {
                ...
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarMessage)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_contacts)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarButton)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_allow)
                }
            ...
            !state.notificationPermission -> {
                ...
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarMessage)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_notifications)
                }
                (binding.snackbar as? ViewStub)?.findViewById<View>(R.id.snackbarButton)?.let {
                    (it as? dev.danascape.messages.common.widget.QkTextView)?.setText(R.string.main_permission_allow)
                }
