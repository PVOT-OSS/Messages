...
## Translate
To translate this app join our [Weblate project](https://hosted.weblate.org/engage/pvot-messages/). From here you can begin editing strings on the web. We have a few guidelines for translations: 
...
## Update the Wiki 
To update the wiki, simply navigate to the [wiki tab](https://github.com/danascape/Messages/wiki) in this repository, find the file that you need to edit, and then click `Edit Page`. Then you can edit and commit your change. For more sizeable changes, and for feedback and questions please comment in [this discussion](https://github.com/danascape/Messages/discussions/174).
## Fix Bugs 
